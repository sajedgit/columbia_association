...
@section('main')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            {{ Form::text('board_members_category_name', $value = null ,array('class' => 'form-control','placeholder'=>Lang::get('board_members_categories.board_members_category_name'))) }}
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-4 mb-3 mb-sm-0">
        ...
        <div class="col-sm-8">
            {{ Form::number('board_members_category_position', $value = 1 ,array('class' => 'form-control','placeholder'=>Lang::get('board_members_categories.board_members_category_position'))) }}
        </div>
    </div>
